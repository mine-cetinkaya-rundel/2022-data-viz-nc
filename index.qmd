...
subtitle: "<br>🔗 [bit.ly/dataviz-ncpma](https://bit.ly/dataviz-ncpma)"
author: "<br> dr. mine çetinkaya-rundel <br> duke university"
format: 
  revealjs:
    height: 900
    width: 1600
...
## Case study 2: <br> Bachelor's degrees
...
## Case study 3: <br> COVID-19 Deaths
...
-   Tools: All visualizations presented have been created with [R](https://cran.r-project.org/) and [ggplot2](https://ggplot2.tidyverse.org/)
    ...
    -   For those who are interested, the source code can be found [here](https://github.com/mine-cetinkaya-rundel/2021-data-viz-nc)
